...
CREATE TABLE `spot` (
  ...
  `best_season` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '适宜游玩月份(1-12,逗号分隔)',
  `tags` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '特色标签(逗号分隔)',
  `recommended_duration` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '建议游玩时长',
